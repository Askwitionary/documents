...
\title{A marvelous title}% Force line breaks with \\
%\thanks{My team: The best ever burdensome}%

\author{Lingxiao Duan}
 \email{duanlingxiao1219@sina.com}
 \homepage{https://askwitioniary.github.io}
\affiliation{%
...
\author{Zihan Jiang}
\affiliation{
  M.D. Peking Union Medical College Hospital
}%
\author{Shengsheng Zhuang}
\affiliation{%
 M.D.(In pursuit) Peking Union Medical College
}%
